...
class CapitalT(object):
    ...
    def clone(self):
        ...
        save = CapitalT(rg.Point((self.h_rect.corner_1.x + self.h_rect.corner_2.x) / 2, (self.h_rect.corner_1.y + self.h_rect.corner_2.y) / 2),
                        self.h_rect.corner_2.x - self.h_rect.corner_1.x, self.v_rect.corner_2.y - self.v_rect.corner_1.y,
                        self.h_rect.corner_2.y - self.h_rect.corner_1.y)
        save.h_rect.fill_color = self.h_rect.fill_color
        save.v_rect.fill_color = self.v_rect.fill_color
        save.h_rect.outline_color = self.h_rect.outline_color
        save.v_rect.outline_color = self.v_rect.outline_color
        return save
